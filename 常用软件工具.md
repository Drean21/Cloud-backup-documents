...
1. 小丸工具箱：封装音视频文件【推荐封装成MKV】
2. PotPlayer：最强播放器，支持流媒体播放和音视频载入播放
...
1. IDM插件：搭配IDM万能嗅探下载（不支持安全加密保护的视频嗅探）

2. 最佳视频下载器edge扩展程序：

   > [视频下载扩展-CocoCut-video downloader - Microsoft Edge Addons](https://microsoftedge.microsoft.com/addons/detail/视频下载扩展cococutvideo-down/npdhgjfiikhgncaacnnodpfchmelnchm)

3. 无差别视频提取工具==【终极解决方案】==：

   > [说明文档](https://segmentfault.com/a/1190000025182822)
   >
   > [Github项目地址](https://github.com/Momo707577045/media-source-extract/blob/master/media-source-extract.user.js)
   >
   > **油猴脚本源码**：
   >
   > ~~~javascript
...
1. [PearOCR，在线图片转文字，免费OCR，在线图片文字提取，本地运算，无上传](https://pearocr.com/#/)
2. [多功能图片转换器无需上传文件 (gitee.io)](https://renzhezhilu.gitee.io/webp2jpg-online/index.html#/)
3. [网页转换助手 (html22.com)，用于百度文库等](http://www.html22.com/d/?url=)
...
无线鼠标无反应：取消自动关闭电源以节约能源选项

[(22 封私信 / 80 条消息) 笔记本无线鼠标老是没反应 - 搜索结果 - 知乎 (zhihu.com)](https://www.zhihu.com/search?type=content&q=笔记本无线鼠标老是没反应)
